...
export default function CadastroScreen() {
  ...
  return (
    <View style={styles.container}>
        ...
        style={styles.logo} 
        />
        <Text style={styles.texto_cadastro}>Cadastro</Text>
        ...
        <TextInput style={styles.input} placeholder='Confirmar senha' placeholderTextColor="#888" secureTextEntry value={senha} onChangeText={setSenha}></TextInput>
        </View>
...
const styles = StyleSheet.create({
    ...
    button_NovaConta: {
      position: 'absolute',
      top: 650, // Posição fixa do botão de nova conta
    },
    continue: {
      position: 'absolute',
      top: 700, // Posição fixa do continue
    }
});